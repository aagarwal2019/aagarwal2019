...
|-----------|---------------|---------|-----|
| **Who's That Pokémon?** | A fun guessing game powered by the PokéAPI | `Python` | [Repo](https://github.com/aagarwal2019/Who-s-That-Pokemon) |
| **Web102 Prework** | CodePath web dev prework — flashcard-style app | `JavaScript` | [Repo](https://github.com/aagarwal2019/web102_prework) |
| **Playlist Chaos** | AI-powered playlist generator (CodePath AI course) | `Python` | [Repo](https://github.com/aagarwal2019/ai110-module1tinker-playlistchaos-starter) |
